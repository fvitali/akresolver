...
/* Controllers */
var tag = '<iframe id="iContent" frameborder="0" wmode="transparent" allowfullscreen="" src="URI" sandbox="allow-forms allow-pointer-lock allow-same-origin allow-scripts allow-popups"></iframe>'	
var tag = '<iframe id="iContent" frameborder="0" wmode="transparent" allowfullscreen="" src="URI"></iframe>'	
$(document).ready(main);
...
function addIframe(loc,uri) {
	if (uri.substr(0,4) == 'http' ) {
		uri = uri.replace(/^.*:\/\//,location.protocol+'//')
