<?PHP 
$code = "0AsRDcuEU3KlqdG1LSFE1QngtRFk2WW1pZ1ZaZGVzUkE";
$arr = array() ; 
$outPath = array('servers.json') ;
$gids = array(0) ;
$dir = "./" ;
$message = "<h1>Updating list of AKN URI resolvers</h1>" ;

function cmp($a, $b) { return $a['sort'] - $b['sort']; }
...
/*
https://docs.google.com/spreadsheet/pub?key=0AsRDcuEU3KlqdG1LSFE1QngtRFk2WW1pZ1ZaZGVzUkE&single=true&gid=0&output=csv
*/
